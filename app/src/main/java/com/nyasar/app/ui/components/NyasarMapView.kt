        ...
        mapView.getMapAsync { map ->
            ...
            map.setStyle(provider.styleUrl(styleVariant)) { style ->
                ...
                if (trackSource != null) {
                    ...
                    style.addLayer(
                        LineLayer(LAYER_TRACK, SOURCE_TRACK).withProperties(
                            PropertyFactory.lineColor("#FF6B00"),
                ...
                if (style.getSourceAs<GeoJsonSource>(SOURCE_HIGHLIGHT) == null) {
                    ...
                    style.addLayer(
                        CircleLayer(LAYER_HIGHLIGHT_CIRCLE, SOURCE_HIGHLIGHT).withProperties(
                            ...
                            PropertyFactory.circleColor("#FF6B00"),
                ...
                if (track.isNotEmpty()) {
                    ...
                    val hasRealSpan = bounds.latitudeSpan > 0.0001 || bounds.longitudeSpan > 0.0001
                    if (hasRealSpan) {
                        map.moveCamera(CameraUpdateFactory.newLatLngBounds(bounds, 80))
                    } else {
                        map.moveCamera(CameraUpdateFactory.newLatLngZoom(bounds.center, 15.0))
                    }
